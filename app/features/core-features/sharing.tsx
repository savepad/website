...
const SharingFeature = () => (
  <section id="tagging" className="mb-12 max-w-full">
    ...
    <p>We&apos;re also working on the ability to make workspaces and collections published to the web, so you can show off your saves to the world as a reference, or as a portfolio!</p><br></br>
  </section>
);
