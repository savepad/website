...
const CollaborationFeature = () => (
  <section id="collaboration" className="mb-12 max-w-full">
    ...
    <p>Savepad is made for collaboration! By default you&apos;ll start out with a personal account. Simply create one or more new teams for home or work, and invite your colleagues, friends, or family to collaborate on saves with you.</p><br></br>
