...
const termsContent = `
Clearly this is dummy content.

## Introduction
Welcome to Savepad. By using our services, you agree to these terms.

### Changes to Terms
We may update the terms from time to time. 

## Account
You need to create an account to use Savepad.

### Account Security
You are responsible for maintaining the security of your account.

## Content
You retain ownership of the content you create with Savepad.

### Content Rights
By using Savepad, you grant us certain rights to your content.

## Termination
We may terminate your account for violations of these terms.

### Notice of Termination
We will provide notice before terminating your account.
...
const Terms: React.FC = () => {
  ...
  return (
    <main>
      ...
      <div>
          <div>
            <SimpleContent content={termsContent} />
          </div>
        </div>
    </main>
  );
